...
class AllMobListScreen extends StatefulWidget {
  const AllMobListScreen({super.key});

  @override
  State<AllMobListScreen> createState() => _AllMobListScreenState();
}

class _AllMobListScreenState extends State<AllMobListScreen> {
  ...
  Future<void> loadDetails() async {
    ...
    for (int i = 0; i < mlist.length; i++) {
      markers.add(Marker(
        ...
        icon: mlist[i].status=="Active"?BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueGreen): BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
      ));
      circle.add(Circle(
          ...
          radius: 400,
          strokeWidth: 0,
          fillColor:mlist[i].status=="Active"? Color.fromARGB(255, 240, 70, 70).withOpacity(0.3):Color.fromARGB(255, 21, 21, 21).withOpacity(0.3)));
  ...
  Widget build(BuildContext context) {
   ...
   //           height: 550.0,
              ...
              child: GoogleMap(
                ...
                markers: selectedIndex==0? Set<Marker>.of(markers):selectedIndex==1?Set<Marker>.of(markers1):Set<Marker>.of(markers2),
        //        circles: selectedIndex==0? Set<Circle>.of(circle):selectedIndex==1?Set<Circle>.of(circle1):Set<Circle>.of(circle2),
              ),
            ),
          ],
        ),
