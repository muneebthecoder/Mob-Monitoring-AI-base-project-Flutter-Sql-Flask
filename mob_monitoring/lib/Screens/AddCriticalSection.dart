...
class AddCriticalSection extends StatefulWidget {
  const AddCriticalSection({super.key});

  @override
  State<AddCriticalSection> createState() => _AddCriticalSectionState();
}

class _AddCriticalSectionState extends State<AddCriticalSection> {
                                ...
                                child: Center(
                                    child: Text("Add",
                                        style: TextStyle(
                                            ...
                                            fontWeight: FontWeight.bold)))),
                            onTap: () async {
                              if (radiusC.text == "" || locationc.text == "") {
                                showDialog(
                                    context: context,
                                    builder: (context) {
                                      return AlertDialog(
                                ...
                                int statuscode =
                                    await APIHandler().AddCriticalPoints(
                                  longitude!,
                                  latitude!,
                                                                    locationc.text,
